...
if __name__ == "__main__":
    ...
    agent = DQNAgent(state_size, action_size, fc1_size=128, fc2_size=128, device=device, gamma=gamma, epsilon=-1, epsilon_min=0, epsilon_decay=0, learning_rate=learning_rate, memory_size=memory_size)
    agent.load_model("saved_models/DQN Acrobot_olive-pyramid-9_dqn_at_100_successes.pt")

    vdp_agent = None # VDPDQNAgent(state_size, action_size, kl_w_factor = kl_w_factor, kl1_w_factor = kl1_w_factor, kl2_w_factor = kl2_w_factor, kl3_w_factor = kl3_w_factor, kl_b_factor = kl_b_factor, kl1_b_factor = kl1_b_factor, kl2_b_factor = kl2_b_factor, kl3_b_factor = kl3_b_factor, fc1_size=fc1_size, fc2_size=fc2_size, device=device, gamma=gamma, k = k, learning_rate=learning_rate, memory_size=memory_size)
    vdp_env = None # gym.make("Acrobot-v1")
