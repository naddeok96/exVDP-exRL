...
from torch_exVDP_MLP_v2 import exVDPMLP, nll_gaussian
...
def main_function(input_dim=784, hidden_dim=10, output_dim=10, batch_size=1, epochs=1, lr=0.001, kl_factor = 0.001,
                  random_noise=True, gaussian_noise_std=10000, training=False, PATH="dump/",  gpu="4"):
    
    
    # Use GPU or CPU based on argument
    if gpu is not None:
